...
((SELECT dog_id FROM Dogs WHERE name = 'Minh'), 2025-06-12 10:00:00, 70, 'Sofras AB', 'accepted'),
((SELECT dog_id FROM Dogs WHERE name = 'Griffith'), 2025-06-9 08:00:00, 5, 'Off a Cliff', 'completed');